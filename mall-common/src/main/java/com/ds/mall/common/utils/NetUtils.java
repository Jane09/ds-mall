...
import com.ds.mall.common.exception.MallSystemException;
...
public final class NetUtils {
    ...
    public static void main(String[] args) {
        System.out.println(StringUtils.join(getIntranetIP(),":",2181));
        System.out.println(StringUtils.join(getInternetIp(),":",2181));
    ...
    public static String getHost() {
        ...
        try {
            ...
            throw new MallSystemException(e);
        }
